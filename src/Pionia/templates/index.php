...
<nav class="navbar navbar-expand-lg navbar-dark pionia-color">
    <div class="container">
        <div class="d-inline-flex align-content-center align-items-center">
            ...
            <a class="navbar-brand fw-bold" href="#">{{framework()}}</a>
        </div>
...
<section class="hero">
    <div class="container bg-purple">
        ...
        <h1 class="display-3 fw-bold">{{appName()}}</h1>
        <p class="mt-3 font-weight-bold" style="color: #21da21">{{appName()}} is up and running <?php if (isDebug()): ?> on port {{env('SERVER_PORT')}}{{apiBase()}} <?php endif; ?> <i class="bi bi-open-browser"></i></p>
        <div class="mt-4">
...
<section class="py-5 bg-light" id="features">
    <div class="container text-center">
        <h2 class="mb-4">Why {{framework()}}?</h2>
        <div class="row g-4">
            <div class="col-md-4">
...
<footer class="text-center py-4 bg-dark text-white">
    <img src="/static/pionia_logo.webp" class="mx-auto h-25 w-25" alt="{{app()->getAppName()}} - {{env('APP_ENV')}}"/>

    <div class="container">
        &copy; <?= date('Y') ?> {{framework()}} &mdash; ❤️ {{frameworkTag()}}
    </div>
</footer>
