 ...
 *
 * @method array select(string $table, array $columns, callable $callback)
 * @method array select(string $table, array $columns, array $where, callable $callback)
 * @method array select(string $table, array $columns, array $where)
 * @method array select(string $table, array $join, array $columns, array $where, callable $callback)
...
class Piql
{
     ...
     * @var string|null
     */
    public ?string $prettyQuery = null;
